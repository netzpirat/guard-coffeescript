...
=== Rails app with CoffeeScripts accross several subdirectories

If you organize your CoffeeScripts in a directory structure and want to compile these to an output folder that
contains a part of these directories, you'll have to script your guards for now:

    require 'find'
    
    Find.find('app/coffeescripts') do |path|
      if FileTest.directory?(path)
        guard 'coffeescript', :output => "public/javascripts/compiled/#{ path.gsub('app/coffeescripts', '') }" do
          watch ("^#{ path }/[^/]*\.coffee")
        end
      end
    end
